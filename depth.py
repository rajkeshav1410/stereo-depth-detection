...
cv2.setTrackbarPos('textureThreshold', 'disp', camera_params['textureThreshold'])
...
cv2.setTrackbarPos('speckleWindowSize', 'disp', camera_params['speckleWindowSize'])
...
while True:
	...
	camera_params["preFilterType"] = cv2.getTrackbarPos('preFilterType', 'disp')
	camera_params["preFilterSize"] = cv2.getTrackbarPos('preFilterSize', 'disp')
	camera_params["preFilterCap"] = cv2.getTrackbarPos('preFilterCap', 'disp')
	camera_params["textureThreshold"] = cv2.getTrackbarPos('textureThreshold', 'disp')
	...
	camera_params["disp12MaxDiff"] = cv2.getTrackbarPos('disp12MaxDiff', 'disp')
	...
	if marking:
		...
		# mask = np.zeros(imgRight.shape[:2], np.uint8)
